...
interface SchedulerContextType {
  ...
  // Combined actions
  moveAssignmentGroup: (assignments: Assignment[], jobId: string, row: RowType, position?: number) => string;
  assignResourceWithAttachment: (resourceId: string, parentAssignmentId: string) => string | null;
