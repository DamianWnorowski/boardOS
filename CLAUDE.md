...
### Latest Changes
- eb04912 - chore(husky): auto-commit generated docs in post-commit (26 seconds ago)
- 7f7c746 - chore(docs): finalize generated docs without re-running hooks (30 minutes ago)
- f0ce9a1 - chore(docs): sync post-commit updates (31 minutes ago)
- fee8aa6 - chore(docs): post-commit generated updates (34 minutes ago)
- 0dd68d7 - chore(docs): commit regenerated API docs and metadata (39 minutes ago)
...
- **src/components/resources/AssignmentCard.tsx**: Updated 43 minutes ago
...
- 44dd54c - chore: update project files (12 minutes ago)
- 27a3af7 - chore: commit current development state with documentation and AI provider updates (87 minutes ago)
...
- **src/context/SchedulerContext.tsx**: Updated 6 hours ago
- **src/services/DatabaseService.ts**: Updated 19 hours ago
- **src/components/resources/AssignmentCard.tsx**: Updated 12 minutes ago
- **src/utils/colorSystem.ts**: Updated 3 days ago

### Latest Changes
- fee8aa6 - chore(docs): post-commit generated updates (16 seconds ago)
- 0dd68d7 - chore(docs): commit regenerated API docs and metadata (5 minutes ago)
- 44dd54c - chore: update project files (9 minutes ago)
- 27a3af7 - chore: commit current development state with documentation and AI provider updates (84 minutes ago)
...
- **src/context/SchedulerContext.tsx**: Updated 6 hours ago
- **src/services/DatabaseService.ts**: Updated 19 hours ago
- **src/components/resources/AssignmentCard.tsx**: Updated 9 minutes ago
- **src/utils/colorSystem.ts**: Updated 3 days ago

### Latest Changes
- 0dd68d7 - chore(docs): commit regenerated API docs and metadata (13 seconds ago)
- 44dd54c - chore: update project files (4 minutes ago)
- 27a3af7 - chore: commit current development state with documentation and AI provider updates (79 minutes ago)
- 621b031 - chore: clean up temporary and obsolete files (3 hours ago)
...
### Critical File Updates
- **src/context/SchedulerContext.tsx**: Updated 6 hours ago
- **src/services/DatabaseService.ts**: Updated 18 hours ago
- **src/components/resources/AssignmentCard.tsx**: Updated 4 minutes ago
- **src/utils/colorSystem.ts**: Updated 3 days ago

### Latest Changes
- 44dd54c - chore: update project files (6 seconds ago)
- 27a3af7 - chore: commit current development state with documentation and AI provider updates (75 minutes ago)
- 621b031 - chore: clean up temporary and obsolete files (3 hours ago)
- a02863c - chore: update project configuration, tests, and tooling scripts (3 hours ago)
...
- **Contexts**: 11
- **Services**: 5
- **Lines of Code**: 41,570

### Critical File Updates
- **src/context/SchedulerContext.tsx**: Updated 6 hours ago
- **src/services/DatabaseService.ts**: Updated 18 hours ago
- **src/components/resources/AssignmentCard.tsx**: Updated 6 seconds ago
- **src/utils/colorSystem.ts**: Updated 3 days ago
